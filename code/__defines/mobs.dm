...
//LEGAL IDEOLOGY
#define IDEOLOGY_MONARCHISM		"Монархизм"
#define IDEOLOGY_CONSERVATISM	"Отсутствует"
#define IDEOLOGY_LIBERALISM		"Либерализм"
#define IDEOLOGY_DEMSOC			"Демократический социализм"
#define IDEOLOGY_NATIONALIST	"Национализм"

#define LEGAL_IDEOLOGY			list(IDEOLOGY_MONARCHISM,IDEOLOGY_CONSERVATISM,IDEOLOGY_LIBERALISM,IDEOLOGY_DEMSOC,IDEOLOGY_NATIONALIST)

//ILLEGAL IDEOLOGY

#define IDEOLOGY_LIBERT			"Либертарианство"
#define IDEOLOGY_COMMUNISM		"Коммунизм"
#define IDEOLOGY_FASCISM		"Фашизм"
#define IDEOLOGY_NARSIE			"Религиозный экстремизм"
